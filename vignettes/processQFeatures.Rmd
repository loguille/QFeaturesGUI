...
Once the normalisation method is selected you can click on `Apply normalisation` (`A`), this will display the post normalisation plot (`B`). Once this is done click on `Save the processed sets`. 
