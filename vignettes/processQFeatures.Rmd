...
The Log base is by default set to 2 and a pseudocount value can be added to handle zero values in data before applying logarithm.
...
First choose an imputation method :
...
Then click on `Apply imputation`, once the imputation has run the page will display a Post-imputation density plot which you can color by colData. 
